...
fileprivate class LogisticsCenter: NSObject {
    ...
    func storeParcel<T>(_ recipient: String,_ parcel: Parcel<T>) {
        ...
        if warehouse[recipient] == nil {
            ...
            parcelSet = warehouse[recipient]?.mutableCopy() as! NSMutableSet
        }
    ...
    func collectStoredParcel(_ recipient: Actor) -> NSSet? {
...
class Courier: Actor {
    ...
    private func _beClaim(
        ...
        let parcelSet = center.collectStoredParcel(recipient)
        if parcelSet != nil {
